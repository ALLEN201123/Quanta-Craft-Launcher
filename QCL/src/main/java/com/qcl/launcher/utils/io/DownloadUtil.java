...
import static com.qcl.launcher.task.DownloadTask.downloadFileMonitored;
                    ...
                    for (int i = 0; i < tryTimes; i++) {
                        ...
                        DownloadTask.DownloadFeedback fb = new DownloadTask.DownloadFeedback() {
                            ...
                            public void updateProgress(long curr, long max) {
                                long progress = max > 0 ? Math.min(100, 100 * curr / max) : 0;
                        ...
                        if (downloadFileMonitored(bean.urlForAttempt(i), path, sha1, fb)) {
                            activity.runOnUiThread(() -> {
