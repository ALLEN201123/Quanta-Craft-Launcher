...
import static com.qcl.launcher.control.bean.BaseButtonInfo.POSITION_TYPE_PERCENT;
import static com.qcl.launcher.control.bean.BaseButtonInfo.SIZE_OBJECT_WIDTH;
import static com.qcl.launcher.control.bean.BaseButtonInfo.SIZE_TYPE_PERCENT;
...
public class BaseButton extends androidx.appcompat.widget.AppCompatButton {
    ...
    private void handleDoubleClick() {
        ...
        for (java.util.Iterator<String> it = info.visibilityControl.iterator(); it.hasNext(); ) {
