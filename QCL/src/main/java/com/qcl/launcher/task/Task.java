...
import com.qcl.launcher.event.EventManager;
import com.qcl.launcher.utils.Logging;
import com.qcl.launcher.utils.ReflectionHelper;
import com.qcl.launcher.utils.function.ExceptionalConsumer;
...
public abstract class Task<T> {
    ...
    private static String getCaller() {
        return ReflectionHelper.getCaller(packageName -> !"com.qcl.launcher.task".equals(packageName)).toString();
    }
