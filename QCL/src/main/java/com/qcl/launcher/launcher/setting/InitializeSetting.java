...
public class InitializeSetting {
    ...
    public static LauncherSetting initializeLauncherSetting(){
        ...
        if (new File(AppManifest.SETTING_DIR + "/launcher_setting.json").exists()){
            ...
            launcherSetting = new LauncherSetting(AppManifest.DEFAULT_GAME_DIR,new SourceSetting(true,1,0),0,64,false,true,false,false,false,"DEFAULT","DEFAULT",new BackgroundSetting(0,"",""),AppManifest.DEFAULT_CACHE_DIR);
