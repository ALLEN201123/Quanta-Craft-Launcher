...
public final class RendererCompat {
    ...
    public static final Info[] ALL = {new Info("opengles2", "Holy-GL4ES", "Holy GL4ES (OpenGL 2.1)", "libgl4es_114.so", "libEGL.so", "", "1.21.4", "1.21.4", true, true), new Info("ng_gl4es", "Krypton Wrapper", "Krypton Wrapper (OpenGL 3.1+, 全版本通吃)", "libng_gl4es.so", "libEGL.so", "", "26.3", "26.3", true, true), new Info("zink", "Zink", "Kopper Zink (OpenGL 4.6, Mesa zink on Vulkan)", "libglxshim.so", "libEGL_mesa.so", "", "26.3", "26.3", true, true), new Info("opengles3_virgl", "VirGLRenderer", "VirGLRenderer (OpenGL 4.3, Mesa 软渲染)", "libOSMesa_81.so", "libEGL.so", "", "26.3", "26.3", true, true), new Info("opengles3_virgl_osmesa8", "Freedreno", "Freedreno (OpenGL 4.6, 仅高通 adreno616-a660)", "libOSMesa_8.so", "libEGL.so", "", "26.3", "26.3", true, false), new Info("opengles3_vgpu", "VGPU", "VGPU (OpenGL 2.1+)", "libvgpu.so", "libEGL.so", "", "1.16.5", "1.16.5", true, false), new Info("mg", "MobileGlues", "MobileGlues (外部渲染器：安装官方 MobileGlues 插件 APK 后自动识别)", "libmobileglues.so", "libEGL.so", "", "26.3", "26.3", false, false)};
