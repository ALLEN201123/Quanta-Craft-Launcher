...
SeekBar.OnSeekBarChangeListener {
    ...
    public void onCreate() {
        ...
        this.showBoatRendererSetting = (LinearLayout)this.activity.findViewById(R.id.show_boat_render_selector);
        this.currentBoatRenderer = (TextView)this.activity.findViewById(R.id.current_boat_renderer);
        this.showBoatRenderer = (ImageView)this.activity.findViewById(R.id.show_boat_renderer);
        this.boatRendererSetting = (LinearLayout)this.activity.findViewById(R.id.boat_render_selector);
        ...
        this.showPojavRenderer = (ImageView)this.activity.findViewById(R.id.show_pojav_renderer);
        this.pojavRendererSetting = (LinearLayout)this.activity.findViewById(R.id.pojav_render_selector);
        ...
        this.launchByBoat = (RadioButton)this.activity.findViewById(R.id.launch_by_boat);
        this.launchByPojav = (RadioButton)this.activity.findViewById(R.id.launch_by_pojav);
        this.boatRendererGL4ES114 = (RadioButton)this.activity.findViewById(R.id.boat_renderer_gl4es_114);
        this.boatRendererVirGL = (RadioButton)this.activity.findViewById(R.id.boat_renderer_virgl);
        this.pojavRendererGL4ES114 = (RadioButton)this.activity.findViewById(R.id.pojav_renderer_gl4es_114);
        this.pojavRendererVirGL = (RadioButton)this.activity.findViewById(R.id.pojav_renderer_virgl);
    ...
    private void init() {
        ...
        if (this.activity.privateGameSetting.boatLauncherSetting.enable) {
        ...
        if (this.activity.privateGameSetting.boatLauncherSetting.renderer.equals("libGL112.so.1") || this.activity.privateGameSetting.boatLauncherSetting.renderer.equals("libGL115.so.1") || this.activity.privateGameSetting.boatLauncherSetting.renderer.equals("libgl4es_114.so") || this.activity.privateGameSetting.boatLauncherSetting.renderer.equals("libvgpu.so") || this.activity.privateGameSetting.boatLauncherSetting.renderer.equals("GL4ES115") || this.activity.privateGameSetting.boatLauncherSetting.renderer.equals("GL4ES114")) {
        ...
        } else if (this.activity.privateGameSetting.boatLauncherSetting.renderer.equals("VirGL")) {
        ...
        if (this.activity.privateGameSetting.pojavLauncherSetting.renderer.equals("opengles2") || this.activity.privateGameSetting.pojavLauncherSetting.renderer.equals("opengles2_5") || this.activity.privateGameSetting.pojavLauncherSetting.renderer.equals("opengles3") || this.activity.privateGameSetting.pojavLauncherSetting.renderer.equals("opengles3_vgpu")) {
        ...
        } else if (this.activity.privateGameSetting.pojavLauncherSetting.renderer.equals("opengles3_virgl")) {
    ...
    public void onClick(View v) {
        ...
        if (v == this.showPojavRendererSetting || v == this.showPojavRenderer) {
        ...
        if (v == this.launchByBoat) {
            if (com.qcl.launcher.utils.Architecture.getDeviceArchitecture() == com.qcl.launcher.utils.Architecture.ARCH_ARM64) {
                this.launchByPojav.setChecked(false);
                this.activity.privateGameSetting.boatLauncherSetting.enable = true;
                this.activity.privateGameSetting.pojavLauncherSetting.enable = false;
                GsonUtils.savePrivateGameSetting(this.activity.privateGameSetting, AppManifest.SETTING_DIR + "/private_game_setting.json");
                this.currentLauncher.setText(this.context.getText(R.string.game_setting_ui_game_launcher_boat));
            } else {
                ...
                this.launchByBoat.setChecked(false);
                this.launchByPojav.setChecked(true);
                this.activity.privateGameSetting.boatLauncherSetting.enable = false;
        ...
        if (v == this.boatRendererGL4ES114) {
            this.boatRendererVirGL.setChecked(false);
            this.activity.privateGameSetting.boatLauncherSetting.renderer = "GL4ES114";
            GsonUtils.savePrivateGameSetting(this.activity.privateGameSetting, AppManifest.SETTING_DIR + "/private_game_setting.json");
            this.currentBoatRenderer.setText(this.context.getText(R.string.game_setting_ui_boat_renderer_gl4es_114));
        }
        if (v == this.boatRendererVirGL) {
            this.boatRendererGL4ES114.setChecked(false);
            this.activity.privateGameSetting.boatLauncherSetting.renderer = "VirGL";
            GsonUtils.savePrivateGameSetting(this.activity.privateGameSetting, AppManifest.SETTING_DIR + "/private_game_setting.json");
            this.currentBoatRenderer.setText(this.context.getText(R.string.game_setting_ui_boat_renderer_virgl));
        }
        if (v == this.pojavRendererGL4ES114) {
            this.pojavRendererVirGL.setChecked(false);
            this.activity.privateGameSetting.pojavLauncherSetting.renderer = "opengles2";
            GsonUtils.savePrivateGameSetting(this.activity.privateGameSetting, AppManifest.SETTING_DIR + "/private_game_setting.json");
            this.currentPojavRenderer.setText(this.context.getText(R.string.game_setting_ui_pojav_renderer_gl4es_114));
        }
        if (v == this.pojavRendererVirGL) {
            this.pojavRendererGL4ES114.setChecked(false);
            this.activity.privateGameSetting.pojavLauncherSetting.renderer = "opengles3_virgl";
            GsonUtils.savePrivateGameSetting(this.activity.privateGameSetting, AppManifest.SETTING_DIR + "/private_game_setting.json");
            this.currentPojavRenderer.setText(this.context.getText(R.string.game_setting_ui_pojav_renderer_virgl));
        }
