...
public class Datapack {
    ...
    public void loadFromZip() throws IOException {
        if (ZipTools.isFileExist(path.toString(),"datapacks")) {
            isMultiple = true;
            com.qcl.launcher.utils.file.FileUtils.deleteDirectory(AppManifest.DEFAULT_CACHE_DIR + "/datapacks");
            com.qcl.launcher.utils.file.FileUtils.createDirectory(AppManifest.DEFAULT_CACHE_DIR + "/datapacks");
