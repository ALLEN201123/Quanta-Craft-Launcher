...
public class MainUI extends BaseUI implements View.OnClickListener, AdapterView.OnItemSelectedListener {
    ...
    private void refreshAccountModel() {
        ...
        try {
            com.tungsten.hmclpe.auth.Account account = activity.publicGameSetting.account;
    ...
    private void applyOfflineSkin(com.tungsten.hmclpe.auth.Account account) {
        com.tungsten.hmclpe.auth.offline.OfflineSkinSetting offline = account.offlineSkinSetting;
        ...
        switch (type) {
            ...
            case 5:   // Blessing Skin server configured by the player
                if (offline != null && offline.server != null && !offline.server.isEmpty()) {
                    ...
                    fetchRemoteSkin(com.tungsten.hmclpe.utils.string.StringUtils.removeSuffix(base, "/") + "/",
    ...
    private void fetchRemoteSkin(final String base, final String playerName) {
        new Thread(() -> {
            ...
            Bitmap cape = null;
            try {
                String json = com.tungsten.hmclpe.utils.io.NetworkUtils.doGet(
                        com.tungsten.hmclpe.utils.io.NetworkUtils.toURL(base + playerName + ".json"));
                com.tungsten.hmclpe.auth.offline.SkinJson result =
                        com.tungsten.hmclpe.utils.gson.JsonUtils.GSON.fromJson(
                                json, com.tungsten.hmclpe.auth.offline.SkinJson.class);
    ...
    public void onClick(View v) {
        ...
        if (v == startMultiPlayerUI){
            com.tungsten.hmclpe.launcher.terracotta.MultiplayerDialogHelper.showEnable(activity, context);
        }
        if (v == startSettingUI){
