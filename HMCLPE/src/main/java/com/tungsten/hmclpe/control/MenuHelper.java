...
public class MenuHelper implements CompoundButton.OnCheckedChangeListener, View.OnClickListener, AdapterView.OnItemSelectedListener, SeekBar.OnSeekBarChangeListener {
    ...
    public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
        ...
        if (compoundButton == switchLaunchLog) {
            ...
            GameMenuSetting.saveGameMenuSetting(gameMenuSetting);
            if (b) {
                com.tungsten.hmclpe.launcher.launch.LaunchLogWindow.showFor(activity, drawerLayout);
            } else {
                com.tungsten.hmclpe.launcher.launch.LaunchLogWindow.closeCurrentIfAny();
            }
        }
    ...
    private void showMultiplayerMenu() {
        com.tungsten.hmclpe.launcher.terracotta.MultiplayerDialogHelper.showInGame(activity, context);
    }
