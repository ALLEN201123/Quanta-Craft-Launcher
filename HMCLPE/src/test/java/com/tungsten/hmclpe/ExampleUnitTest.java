...
public class ExampleUnitTest {
    ...
    @Test public void fallbackKeepsMirrorFirstThenUsesOriginal() {
        com.tungsten.hmclpe.launcher.list.install.DownloadTaskListBean bean =
                new com.tungsten.hmclpe.launcher.list.install.DownloadTaskListBean("client", "https://mirror.test/client", "client.jar", "hash")
    ...
    @Test public void thirdPartyLibraryUrlAndMissingTrailingSlashArePreserved() {
        Gson gson = JsonUtils.defaultGsonBuilder().registerTypeAdapter(Artifact.class, new Artifact.Serializer()).create();
        com.tungsten.hmclpe.launcher.game.Library library = gson.fromJson("{\"name\":\"example:mod:1\",\"url\":\"https://repo.example.test/maven\"}", com.tungsten.hmclpe.launcher.game.Library.class);
